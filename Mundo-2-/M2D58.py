...
janela.title('Jogo da adivinhação ') #Cabeçalho do programa
#Solicitando que o jogador adivinhe um número de 0 á 5
texto_orientacao = Label(janela, text='Estou pensando em um número de 0 a 10, consegue advinhar??')
texto_orientacao.grid(column=0,row=0)
botao = Button(janela,text='Consigo !',command=inserir_numero)
